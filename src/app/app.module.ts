...
@NgModule({
  ...
  providers: [{ provide: RouteReuseStrategy, useClass: IonicRouteStrategy },FirebaseMessaging,Globalization,FileTransfer,File,ImagePicker,Network,CallNumber,StatusBar,SocialSharing,Clipboard,InAppBrowser],
